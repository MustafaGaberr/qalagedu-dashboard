...
export const initialTeacherProfiles: TeacherProfile[] = [
  { id: "teacher_ahmed", name: "أ. أحمد عبد الرحمن", subject: "الرياضيات", grades: ["الثالثة الثانوية"], courseIds: ["course_math"], groupIds: ["group_math_a", "group_math_b"], status: "ACTIVE" },
  { id: "teacher_mona", name: "أ. منى السيد", subject: "الفيزياء", grades: ["الثالثة الثانوية"], courseIds: ["course_physics"], groupIds: ["group_physics_c"], status: "ACTIVE" },
];
