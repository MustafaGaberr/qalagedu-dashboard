...
export interface TeacherProfile { id: string; name: string; loginIdentifier?: string; subject: string; bio?: string; photoUrl?: string; grades: string[]; courseIds: string[]; groupIds: string[]; status: StaffStatus; }
...
export interface StaffAccountInput { name: string; loginIdentifier: string; password?: string; status?: StaffStatus; }
