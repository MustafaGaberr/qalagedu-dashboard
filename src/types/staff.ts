...
export interface TeacherProfile { id: string; name: string; loginIdentifier?: string; subject: string; grades: string[]; courseIds: string[]; groupIds: string[]; status: StaffStatus; }
